...
import SliderOnboarding from '../../Authentication/components/SliderOnboarding';
import { Box, Text } from '../../components';
import { SettingsStackNavigationProps } from '../../components/Navigation';
import { useTypedSelector } from '../../hooks';

const SettingsEmission = ({ navigation }: SettingsStackNavigationProps<'SettingsEmission'>) => {
