...
const NewCarTripScreen = ({navigation}: TripStackNavigationProps<'NewCarTripScreen'>)=>{
    ...
    return (
      ...
      <Box style={{ flexDirection: 'row', justifyContent: 'center' }}>
        <Button variant={tripData.vehicle_type === "petrol_car" ? "primary" : "default"} label="Essence" onPress={switchPetrol} style={styles.Button}  />
        <Button variant={tripData.vehicle_type === "diesel_car" ? "primary" : "default"} label="Diesel" onPress={switchDiesel} style={styles.Button} />
        <Button variant={tripData.vehicle_type === "electric_car" ? "primary" : "default"} label="Electrique" onPress={switchElectric} style={styles.Button} />
      </Box>
      {errorMessage ? (
          <Text
            variant="body"
