export const ecologyFacts: string[] = [
    ...
    '416 parts per million. The concentration of carbon dioxide (CO2) in our atmosphere, as of May 2020, is the highest it has been in human history.',

    '2019 was the second warmest year on record. NASA data show that average global temperatures in 2019 were 0.98 degrees C warmer than the 20th century average. In fact, the five warmest years in the 1880–2019 record have all occurred since 2015.',

    'Eleven percent of all global greenhouse gas emissions caused by humans are due to deforestation 5 — comparable to the emissions from all of the passenger vehicles on the planet.',
