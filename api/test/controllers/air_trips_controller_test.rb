...
class AirTripsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create air_trip' do
    assert_difference('AirTrip.count') do
      post air_trips_url,
           params: {
             air_trip: {
               distance: @air_trip.distance,
               round_trip: @air_trip.round_trip
             }
           },
           as: :json
    end
  ...
  test 'should destroy air_trip' do
    assert_difference('AirTrip.count', -1) { delete air_trip_url(@air_trip), as: :json }
